...
class Menu:
	...
	def delete_order(self):
		...
		car = self.__current_order.get_license_plate() #Gets a license plate for current order.
		self.vehicle_manager.delete_order_dates(dates, car) #A function that deletes the dates a vehicle is rented.
	...
	def register_order(self):
		...
		start_date, end_date = self.order_manager.get_dates() # Gets dates from order_manager
